import {Mesh, MeshStandardMaterial, BufferAttribute, BufferGeometry, TextureLoader, MathUtils} from "three";
...
export default function () {
    ...
    const vertices = [
        ...
        { pos: [w , 0, h], norm: [0, 1, 0], uv: [0.4, 1] }, // B
        { pos: [w, 0, sh], norm: [0, 1, 0], uv: [0.4, 0] }, // C

        { pos: [w, 0, sh], norm: [0, 1, 0], uv: [0.4, 0] }, // C
        { pos: [sw , 0, sh], norm: [0, 1, 0], uv: [0, 0 ] }, // D
        { pos: [sw, 0, h], norm: [0, 1, 0], uv: [0, 1] }, // A

        { pos: [sw2, 0, h], norm: [0, 1, 0], uv: [0.6, 1] }, // A2
        { pos: [w2 , 0, h], norm: [0, 1, 0], uv: [1, 1] }, // B2
        { pos: [w2, 0, 0], norm: [0, 1, 0], uv: [1, 0] }, // C2

        { pos: [w2, 0, 0], norm: [0, 1, 0], uv: [1, 0] }, // C2
        { pos: [sw2 , 0, 0], norm: [0, 1, 0], uv: [0.6, 0 ] }, // D2
        { pos: [sw2, 0, h], norm: [0, 1, 0], uv: [0.6, 1] }, // A2
    ]
    ...
    sideBottom.position.set(1.1,1.05,-4.171)
